...
final class TimeTest extends HackTest {
  ...
  public function testToString(
    ...
    expect(Time::hours($h, $m, $s, $ns)->toString())->toEqual($expected);
  }
}
