...
final class KeysetIterateTest extends \Facebook\HackTest\HackTest {
  ...
  public function testAppliesAFunctionToEachElement(
    ...
    expect(() ==> Keyset\for_each($traversable, $throwOnEight))->toThrow(
  ...
  public function testAppliesAFunctionToEachElementAndKey(
    ...
    expect(() ==> Keyset\for_each_with_key($traversable, $throwOnThreeAndEight))
      ->toThrow(
        InvalidArgumentException::class,
  ...
  public function testForeachReturnsValuesFromTraversable(
    ...
    expect(Keyset\for_each($traversable, $_ ==> {}))->toBeSame(
      keyset[5, 6, 7, 8, 9],
  ...
  public function testForeachWithKeyReturnsValuesFromTraversable(
    ...
    expect(Keyset\for_each_with_key($traversable, ($_, $_) ==> {}))->toBeSame(
      keyset[5, 6, 7, 8, 9],
      'Values are not being returned',
    );
  }
